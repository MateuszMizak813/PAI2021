<div class="navigation_bar_transparent">
    <div class="logo">
        <div class="logo_pic">
    ...
    <div class="mini_search_bar">
        <form class="search_form" action="searchResults" method="post">
            <div class="search_button">
                <button type="submit">
                    <img class="small_search_icon" src="public/img/icons/search_icon.svg" alt="home_search_icon">
                </button>
            </div>
            <div class="search_input">
                <input class="small_input" name="search" type="text">
            </div>
        </form>
    </div>
    <div class="menu">
